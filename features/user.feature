Feature: User API
  ...
  Scenario: I can't get the list of users
    Given I have the list of entities:
      | Model  |                                            Attrs                                                      |
      |  User  | {"guid":0,"login":"user1","password":"123456","name":"U u1","email":"chernih_av@bk.ru","confirmed":0} |
      |  User  | {"guid":1,"login":"user2","password":"123456","name":"U u2","email":"chernih_av@bk.ru","confirmed":0} |
      |  User  | {"guid":2,"login":"user3","password":"123456","name":"U u3","email":"chernih_av@bk.ru","confirmed":0} |
      |  User  | {"guid":3,"login":"user4","password":"123456","name":"U u4","email":"chernih_av@bk.ru","confirmed":0} |
