Feature: User API
  ...
  Scenario: I can't get the list of users
    Given I have the list of entities:
      | Model  |                                             Attrs                                                  |
      |  User  | {"login":"user1","password":"123456","name":"U u1","email":"chernih_av@bk.ru","confirmed":"false"} |
      |  User  | {"login":"user2","password":"123456","name":"U u2","email":"chernih_av@bk.ru","confirmed":"false"} |
      |  User  | {"login":"user3","password":"123456","name":"U u3","email":"chernih_av@bk.ru","confirmed":"false"} |
      |  User  | {"login":"user4","password":"123456","name":"U u4","email":"chernih_av@bk.ru","confirmed":"false"} |
