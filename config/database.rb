...
database_name = case Padrino.env
  when :development then 'reactor2_development'
  when :production  then 'reactor2_production'
  when :test        then 'reactor2_test'
end
...
#     sessions:
#       default:
#         database: reactor2_development
#         hosts:
#           - localhost:27017 
#   production:
#     sessions:
#       default:
#         database: reactor2_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: reactor2_test
#         hosts:
#           - localhost:27017
#
#
